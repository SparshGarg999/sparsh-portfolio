...
import { Terminal, Bot, X, Send, Sparkles, RefreshCw, Maximize2, Minimize2, Code2 } from "lucide-react";
...
export const UnifiedAICyberHub: React.FC = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content: "Hello! I'm Sparsh Garg's AI Cyber Assistant. Ask me anything about his enterprise AI automations at Genpact, merged PRs in TensorFlow & VS Code, or switch to CLI mode for shell commands.",
    ...
    if (mode === "cli") {
      ...
      switch (cmd) {
        ...
        case "whoami":
          response = (
            <div className="space-y-1 text-slate-200 text-xs font-mono">
              ...
              <p>Software Developer at <span className="text-purple-300 font-semibold">Genpact</span>, engineering ServiceNow & Esker LLM automations.</p>
        ...
        case "contributions":
          response = (
            <div className="space-y-1.5 text-xs font-mono">
              ...
              <p className="text-emerald-400 font-bold">📦 Microsoft Winget: <a href="https://github.com/microsoft/winget-pkgs/pull/403418" target="_blank" rel="noopener noreferrer" className="text-purple-300 underline">PR #403418 [MERGED]</a></p>
        ...
        case "skills":
          response = (
            <div className="space-y-1 text-xs font-mono text-slate-200">
              <p><span className="text-emerald-400 font-bold">AI & ML:</span> LangChain, Multi-Agent RAG, TensorFlow, PyTorch</p>
              <p><span className="text-purple-400 font-bold">Languages:</span> Python, C++, Java, TypeScript, JavaScript, Go, SQL</p>
              <p><span className="text-rose-400 font-bold">Web & Cloud:</span> FastAPI, React, Next.js, Kubernetes, Docker, ServiceNow</p>
            </div>
          );
          break;
        ...
        case "knight":
          response = (
            <div className="text-amber-300 space-y-1 text-xs font-mono">
              ...
              <p>Top 5% globally in graph algorithms and dynamic programming.</p>
      ...
      setTimeout(() => {
        ...
        if (q.includes("genpact") || q.includes("role") || q.includes("work") || q.includes("job")) {
          reply = "Sparsh is a Software Developer at Genpact, engineering enterprise workflow automations across ServiceNow and Esker with Large Language Models and multi-agent RAG pipelines.";
          ...
          reply = "Sparsh has merged PRs in tier-1 repositories: Google TensorFlow (PR #123015), Microsoft VS Code (PR #324132), Microsoft Winget (PR #403418 & #400574), and Kubernetes (PR #140623)!";
        } else if (q.includes("nexus") || q.includes("project")) {
          reply = "NEXUS is an autonomous multi-agent AI research platform built with Python, FastAPI, LangChain, and Tavily AI that generates citation-backed intelligence reports.";
        } else if (q.includes("knight") || q.includes("leetcode") || q.includes("rating")) {
          reply = "Sparsh is a LeetCode Knight with a peak contest rating of 1900+, ranking in the top 5% globally in algorithmic problem solving.";
        } else if (q.includes("contact") || q.includes("email") || q.includes("hire")) {
          reply = "You can reach Sparsh directly at sparshgarg307@gmail.com or connect on LinkedIn at linkedin.com/in/sparsh-garg/!";
        } else {
          reply = "Sparsh Garg is a Software Developer at Genpact and a LeetCode Knight specializing in multi-agent AI systems, Python, FastAPI, React, C++, and enterprise automation. Feel free to ask more!";
        }
  ...
  return (
    <>
      {/* Single Unified Floating Trigger Button */}
      <motion.button
        whileHover={{ scale: 1.06 }}
        whileTap={{ scale: 0.94 }}
        onClick={() => setIsOpen(!isOpen)}
        className="fixed bottom-6 right-6 z-40 flex items-center gap-2.5 px-4 py-3 rounded-full bg-gradient-to-r from-purple-600 via-rose-600 to-indigo-600 shadow-[0_0_25px_rgba(168,85,247,0.45)] text-white hover:brightness-110 transition-all duration-300 font-mono text-xs font-bold pointer-events-auto"
        aria-label="Toggle AI Cyber Terminal"
      >
        <Bot size={17} />
        <span className="hidden sm:inline">AI CYBER HUB</span>
              ...
              <input
                ...
                placeholder={
                  mode === "cli"
                    ...
                    : "Ask anything about Sparsh Garg..."
                }
