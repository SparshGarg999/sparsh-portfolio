...
const projects = [
  {
    id: "001",
    title: "NEXUS: Autonomous Multi-Agent AI Research",
    stack: "Python / FastAPI / LangChain / Groq / Gemini / Tavily AI",
    description: "An autonomous multi-agent AI research and knowledge synthesis platform that searches, analyzes, critiques, and generates citation-backed reports.",
    links: { live: "https://nexus-research-ai.vercel.app/", code: "https://github.com/SparshGarg999/nexus" },
    image: "/nexus_preview.png",
    cta: "Live Platform"
  },
  {
    id: "002",
    title: "ExamArchitect: AI Ingestion & Analytics",
    stack: "React / FastAPI / PostgreSQL / Gemini 2.5 Flash",
    description: "An AI-powered exam analytics platform that structures scanned PDFs using Gemini 2.5 Flash, processes historical questions, and predicts high-priority topics.",
    links: { live: "https://exam-architect-nine.vercel.app/", code: "https://github.com/SparshGarg999/ExamArchitect" },
    image: "/exam_architect_preview.png",
    cta: "Live Platform"
  },
  {
    id: "003",
    title: "Google TensorFlow Contribution",
    stack: "Python / C++ / Build Infrastructure",
    description: "Merged contribution resolving core platform issues and streamlining neural network runtime execution after addressing maintainer feedback.",
    links: { live: "https://github.com/tensorflow/tensorflow/pull/123015#event-28083399208", code: "https://github.com/tensorflow/tensorflow/pull/123015#event-28083399208" },
    image: "/open_source_contributions_preview.png",
    cta: "Explore PR ↗"
  },
  {
    id: "004",
    title: "Microsoft VS Code Contribution",
    stack: "TypeScript / Editor API / UX Refinements",
    description: "Merged contribution improving Visual Studio Code's editor experience by addressing maintainer review comments.",
    links: { live: "https://github.com/microsoft/vscode/pull/324132", code: "https://github.com/microsoft/vscode/pull/324132" },
    image: "/vscode_skillopt_preview.png",
    cta: "Explore PR ↗"
  },
  {
    id: "005",
    title: "Microsoft SkillOpt Contribution",
    stack: "TypeScript / Go / Optimization Testing",
    description: "Merged pull request enhancing optimization capabilities and test coverage for the SkillOpt platform.",
    links: { live: "https://github.com/microsoft/SkillOpt/pull/101", code: "https://github.com/microsoft/SkillOpt/pull/101" },
    image: "/vscode_skillopt_preview.png",
    cta: "Explore PR ↗"
  },
  {
    id: "006",
    title: "Microsoft .NET Contribution",
    stack: "C# / ASP.NET Core / Framework Internals",
    description: "Merged pull request optimizing internal framework logic for ASP.NET Core web services.",
    links: { live: "https://github.com/dotnet/aspnetcore/pull/67810", code: "https://github.com/dotnet/aspnetcore/pull/67810" },
    image: "/dotnet_careerops_preview.png",
    cta: "Explore PR ↗"
  },
  {
    id: "007",
    title: "Career-Ops Contribution",
    stack: "JavaScript / Go / Path Resolution",
    description: "Merged features across path resolution, testing suite enhancements, and developer documentation improvements.",
    links: { live: "https://github.com/santifer/career-ops/pull/966", code: "https://github.com/santifer/career-ops/pull/966" },
    image: "/dotnet_careerops_preview.png",
    cta: "Explore PR ↗"
  },
];
    ...
    >
      <div className="card-top-row">
        ...
        <div className="flex gap-3 flex-wrap">
          ...
          {project.links.code && project.links.code !== "#" && project.links.code !== project.links.live && (
            <StarBorder
              as="a"
...
const SelectedWorks = () => {
  ...
  return (
    <section className="min-h-screen bg-black text-white font-sans relative">
          ...
          <div className="marquee-selected-works__track">
            {[0, 1, 2, 3].map((blockIndex) => (
              <div key={blockIndex} className="marquee-selected-works__segment" aria-hidden={blockIndex > 0 ? "true" : undefined}>
                <span className="marquee-selected-works__text">Featured Projects</span>
      ...
      <div id="work" ref={stackInnerRef} className="scroll-stack-inner px-6 md:px-12 lg:px-16" style={{ transformStyle: 'preserve-3d' }}>
